...
const assertBillingRulesAreServerControlled = () => {
  ...
  const requiredSnippets = [
    ...
    "function renewalRequestMatchesAccount",
...
const assertAppointmentRulesValidatePayloadShape = () => {
  ...
  const appointmentUtilsTest = readFileSync(join(root, "tests", "appointments.test.js"), "utf8");
  ...
  const requiredSnippets = [
    ...
    "function appointmentUsesPublishedService",
    "function appointmentUsesPublishedBarber",
    ...
    "function bookingSlotMatchesAppointment",
    "function bookingSlotReleasedByAppointment",
    ...
    "request.resource.data.client.id == request.resource.data.clientId",
    ...
    "data.time == request.resource.data.rootTime",
  ...
  const snapshotRuntimeSnippets = [
    ...
    [appointmentCard, "src/components/AppointmentCard.jsx", "getAppointmentServiceId(appointment)"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "getAppointmentClientId(appointment)"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "getAppointmentBarberId(appointment)"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "getServicePrice(appointment)"],
  ...
  const submitGuardSnippets = [
    ...
    [appointmentCard, "src/components/AppointmentCard.jsx", "if (success !== false) {"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "actionError"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "editError"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "cancelError"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "Nao foi possivel atualizar o status deste agendamento."],
    [appointmentCard, "src/components/AppointmentCard.jsx", "Nao foi possivel salvar a alteracao"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "Nao foi possivel cancelar este agendamento"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "setActionError(\"\")"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "setEditError(\"\")"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "setCancelError(\"\")"],
    [appointmentCard, "src/components/AppointmentCard.jsx", "role=\"alert\""],
    [appointmentCard, "src/components/AppointmentCard.jsx", "aria-live=\"assertive\""],
...
const assertAuthActionUrlsAreSafe = () => {
  ...
  const authForms = readFileSync(join(root, "src", "utils", "authForms.js"), "utf8");
  ...
  const requiredSnippets = [
    ...
    [loginPage, "src/pages/Login.jsx", "aria-invalid={hasError ? \"true\" : \"false\"}"],
    [loginPage, "src/pages/Login.jsx", "aria-describedby={hasError ? \"login-error\" : undefined}"],
    ...
    [registerPage, "src/pages/Register.jsx", "aria-invalid={hasError ? \"true\" : \"false\"}"],
    [registerPage, "src/pages/Register.jsx", "aria-describedby={hasError ? \"register-error\" : undefined}"],
    ...
    [forgotPasswordPage, "src/pages/ForgotPassword.jsx", "aria-invalid={hasError ? \"true\" : \"false\"}"],
    [forgotPasswordPage, "src/pages/ForgotPassword.jsx", "forgot-password-error"],
    [forgotPasswordPage, "src/pages/ForgotPassword.jsx", "forgot-password-status"],
...
const assertDeletionGuardsQueryActiveAppointments = () => {
  ...
  const requiredSnippets = [
    ...
    [barbersPage, "Barbers.jsx", "deleteBarberActiveCount"],
    [barbersPage, "Barbers.jsx", "Arquivamento bloqueado"],
    [barbersPage, "Barbers.jsx", "disabled={archivingBarber || deleteBarberActiveCount > 0}"],
...
const assertServiceContractIsBounded = () => {
  ...
  const duplicateGuardSnippets = [
    ...
    [servicesPage, "src/pages/Services.jsx", "role=\"status\""],
    [servicesPage, "src/pages/Services.jsx", "aria-live=\"polite\""],
    [servicesPage, "src/pages/Services.jsx", "aria-busy={savingService ? \"true\" : \"false\"}"],
...
const assertBarberContractIsBounded = () => {
  ...
  const duplicateGuardSnippets = [
    ...
    [barbersPage, "src/pages/Barbers.jsx", "role=\"status\""],
    [barbersPage, "src/pages/Barbers.jsx", "aria-live=\"polite\""],
    [barbersPage, "src/pages/Barbers.jsx", "aria-busy={savingBarber ? \"true\" : \"false\"}"],
    [barbersPage, "src/pages/Barbers.jsx", "aria-busy={archivingBarber ? \"true\" : \"false\"}"],
    [barbersPage, "src/pages/Barbers.jsx", "aria-busy={restoringBarberId === barber.id ? \"true\" : \"false\"}"],
...
const assertOperationalDataUsesSoftArchive = () => {
  ...
  const requiredSnippets = [
    ...
    [rules, "firestore.rules", "request.resource.data.updatedAt == request.resource.data.createdAt"],
    ...
    [adminApp, "AdminApp.jsx", "const currentService = services.find((service) => service.id === serviceId)"],
    [adminApp, "AdminApp.jsx", "updatedAt: createdAt"],
    [adminApp, "AdminApp.jsx", "setArchivedServices((prev) => sortByCreatedAtDesc(upsertById(prev, archivedService)))"],
    [adminApp, "AdminApp.jsx", "setArchivedServices(previousArchivedServices)"],
    ...
    [adminApp, "AdminApp.jsx", "sortByName(upsertById(currentClients, restoredClient))"],
    [adminApp, "AdminApp.jsx", "sortByCreatedAtDesc(upsertById(currentServices, restoredService))"],
    [adminApp, "AdminApp.jsx", "sortByName(upsertById(currentBarbers, restoredBarber))"],
    ...
    [barbersPage, "Barbers.jsx", "updatedAt: createdAt"],
...
const assertPublicBookingRequiresPrivacyConsent = () => {
  ...
  const requiredSnippets = [
    ...
    [publicBooking, "src/pages/PublicBooking.jsx", "id=\"privacy-consent\""],
    [publicBooking, "src/pages/PublicBooking.jsx", "aria-describedby=\"privacy-consent-copy\""],
    [publicBooking, "src/pages/PublicBooking.jsx", "id=\"privacy-consent-copy\""],
...
const assertPublicBookingShowsConfirmationSummary = () => {
  ...
  const requiredSnippets = [
    ...
    [publicBooking, "src/pages/PublicBooking.jsx", "onError={(event) =>"],
    [publicBooking, "src/pages/PublicBooking.jsx", "event.currentTarget.style.display = \"none\""],
...
const assertAdminDataSyncCanRetry = () => {
  ...
  const requiredSnippets = [
    ...
    [adminApp, "src/AdminApp.jsx", "additionalDataErrorCount"],
    [adminApp, "src/AdminApp.jsx", "additionalDataWarningCount"],
    [adminApp, "src/AdminApp.jsx", "alerta(s) de sincronizacao"],
    [adminApp, "src/AdminApp.jsx", "aviso(s) de limite"],
    [adminApp, "src/AdminApp.jsx", "role=\"alert\""],
    [adminApp, "src/AdminApp.jsx", "aria-live=\"assertive\""],
    [adminApp, "src/AdminApp.jsx", "aria-live=\"polite\""],
    ...
    [adminApp, "src/AdminApp.jsx", "notificationTimerRef"],
    [adminApp, "src/AdminApp.jsx", "window.clearTimeout(notificationTimerRef.current)"],
    [adminApp, "src/AdminApp.jsx", "notificationTimerRef.current = null"],
...
const assertPublicBookingSubmitRespectsAvailability = () => {
  ...
  const requiredSnippets = [
    ...
    [publicBooking, "src/pages/PublicBooking.jsx", "slotsRefreshToken"],
    ...
    [publicBooking, "src/pages/PublicBooking.jsx", "setSlotsRefreshToken((currentToken) => currentToken + 1)"],
    [publicBooking, "src/pages/PublicBooking.jsx", "setTime(\"\")"],
    [publicBooking, "src/pages/PublicBooking.jsx", "Atualizamos a disponibilidade"],
    ...
    [scheduleUtils, "src/utils/schedule.js", 'import { SERVICE_LIMITS } from "./services.js"'],
    [scheduleUtils, "src/utils/schedule.js", "export const getSafeScheduleDuration"],
    [scheduleUtils, "src/utils/schedule.js", "export const createSlotWritePlan"],
    [scheduleUtils, "src/utils/schedule.js", "SERVICE_LIMITS.durationMin"],
    [scheduleUtils, "src/utils/schedule.js", "SERVICE_LIMITS.durationMax"],
    [scheduleUtils, "src/utils/schedule.js", "SERVICE_LIMITS.durationStep"],
    ...
    [scheduleUtils, "src/utils/schedule.js", "safeValue >= 1440"],
    [scheduleUtils, "src/utils/schedule.js", "safeEnd <= safeStart"],
    ...
    [scheduleTest, "tests/schedule.test.js", "plans booking slot writes without rewriting unchanged slots"],
    [scheduleTest, "tests/schedule.test.js", "SERVICE_LIMITS.durationMax"],
    [scheduleTest, "tests/schedule.test.js", "formats only valid day minutes"],
...
const assertProfileAndDashboardFeedbackIsAccessible = () => {
  ...
  const requiredSnippets = [
    ...
    [profileSetup, "src/pages/ProfileSetup.jsx", "autoComplete=\"organization\""],
    [profileSetup, "src/pages/ProfileSetup.jsx", "inputMode=\"tel\""],
    [profileSetup, "src/pages/ProfileSetup.jsx", "autoComplete=\"tel\""],
    [profileSetup, "src/pages/ProfileSetup.jsx", "inputMode=\"url\""],
    [profileSetup, "src/pages/ProfileSetup.jsx", "autoCapitalize=\"none\""],
    [profileSetup, "src/pages/ProfileSetup.jsx", "spellCheck={false}"],
    [profileSetup, "src/pages/ProfileSetup.jsx", "autoComplete=\"url\""],
    ...
    [profileSettings, "src/pages/ProfileSettings.jsx", "autoComplete=\"organization\""],
    [profileSettings, "src/pages/ProfileSettings.jsx", "inputMode=\"tel\""],
    [profileSettings, "src/pages/ProfileSettings.jsx", "autoComplete=\"tel\""],
    [profileSettings, "src/pages/ProfileSettings.jsx", "inputMode=\"url\""],
    [profileSettings, "src/pages/ProfileSettings.jsx", "autoCapitalize=\"none\""],
    [profileSettings, "src/pages/ProfileSettings.jsx", "spellCheck={false}"],
    [profileSettings, "src/pages/ProfileSettings.jsx", "autoComplete=\"url\""],
  ];
...
const assertWhatsAppTemplatesAreDomainDriven = () => {
  ...
  const requiredSnippets = [
    ...
    [whatsappPage, "src/pages/WhatsApp.jsx", "role=\"status\""],
    [whatsappPage, "src/pages/WhatsApp.jsx", "role=\"alert\""],
    [whatsappPage, "src/pages/WhatsApp.jsx", "aria-live=\"polite\""],
    [whatsappPage, "src/pages/WhatsApp.jsx", "aria-live=\"assertive\""],
