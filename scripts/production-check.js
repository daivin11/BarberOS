...
const assertAppointmentRulesValidatePayloadShape = () => {
  ...
  const requiredSnippets = [
    ...
    "function publicAppointmentUsesPublishedService",
    "function publicAppointmentUsesPublishedBarber",
    ...
    "publicAppointmentUsesPublishedService(request.resource.data['service'].id)",
    "publicAppointmentUsesPublishedBarber(request.resource.data.barberId)",
